...
public class kayakTripFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.kayak_trip, container, false);
    ...
    public void saveTripEdits(){
        if (newTrip){
            db.addTrip("Kayaking",
                    ...
                    ((EditText) view.findViewById(R.id.trip_putin)).getText().toString(),
    ...
    public void createTrip(){
        ...
        ((EditText)view.findViewById(R.id.trip_putin)).setText("");
    ...
    public void retrieveTrip(int key){
        ...
        String putin = tripData.getStartAt();
        ...
        ((EditText)view.findViewById(R.id.trip_putin)).setText(putin);
