...
public class bikeTripFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.bike_trip, container, false);
    ...
    public void saveTripEdits(){
        if (newTrip){
            db.addTrip("Biking",
                    ...
                    ((EditText) view.findViewById(R.id.trip_bikepath)).getText().toString(),
    ...
    public void createTrip(){
        ...
        ((EditText)view.findViewById(R.id.trip_bikepath)).setText("");
    ...
    public void retrieveTrip(int key){
        ...
        String bikepath = tripData.getStartAt();
        ...
        ((EditText)view.findViewById(R.id.trip_bikepath)).setText(bikepath);
