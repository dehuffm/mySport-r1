...
public class skiTripFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.ski_trip, container, false);
    ...
    public void saveTripEdits(){
        if (newTrip){
            db.addTrip("Skiing",
                    ...
                    ((EditText) view.findViewById(R.id.trip_skilift)).getText().toString(),
    ...
    public void createTrip(){
        ...
        ((EditText)view.findViewById(R.id.trip_skilift)).setText("");
    ...
    public void retrieveTrip(int key){
        ...
        String skilift = tripData.getStartAt();
        ...
        ((EditText)view.findViewById(R.id.trip_skilift)).setText(skilift);
